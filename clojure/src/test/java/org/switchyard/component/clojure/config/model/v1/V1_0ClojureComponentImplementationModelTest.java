 ...
 *
 */
public class V1_0ClojureComponentImplementationModelTest {
    
    @Test
    public void inlineScript() throws Exception {
        final V1ClojureComponentImplementationModel implModel = getImplModel("switchyard-clojure-impl-1.0.xml");
    ...
    public void externalFileScript() throws Exception {
        final V1ClojureComponentImplementationModel implModel = getImplModel("switchyard-clojure-impl-file-1.0.xml");
        final Validation validateModel = implModel.validateModel();
    ...
    public void programmaticCreationWithInlineScript() {
        final V1ClojureComponentImplementationModel implModel = new V1ClojureComponentImplementationModel(ClojureComponentImplementationModel.NAMESPACE_1_0);
