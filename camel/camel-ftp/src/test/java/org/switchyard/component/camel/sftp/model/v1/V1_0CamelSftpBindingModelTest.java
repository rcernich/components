 ...
 */
public class V1_0CamelSftpBindingModelTest extends V1CamelSftpBindingModelTest {

    private static final String CAMEL_XML = "/v1/switchyard-sftp-binding-beans-1.0.xml";
    ...
    public V1_0CamelSftpBindingModelTest() {
