 ...
 */
public class V1_0CamelDirectBindingModelTest extends V1CamelDirectBindingModelTest {

    private static final String CAMEL_XML = "switchyard-direct-binding-beans-1.0.xml";

    private static final String CAMEL_URI = "direct://fooDirectName";

    public V1_0CamelDirectBindingModelTest() {
