 ...
 */
public class V1_0CamelMockBindingModelTest extends V1CamelMockBindingModelTest {

    private static final String CAMEL_XML = "switchyard-mock-binding-beans-1.0.xml";

    private static final String CAMEL_URI = "mock://fooMockName?reportGroup=999";

    public V1_0CamelMockBindingModelTest() {
