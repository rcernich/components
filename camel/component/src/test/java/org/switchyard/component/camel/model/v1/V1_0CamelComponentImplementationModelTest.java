 ...
 */
public class V1_0CamelComponentImplementationModelTest {
    ...
    public void validateModelWithJavaElement() throws Exception {
        final V1CamelImplementationModel implModel = getCamelImplementation("switchyard-implementation-java-1.0.xml");
    ...
    public void validateModelWithXMLElement() throws Exception {
        final V1CamelImplementationModel implModel = getCamelImplementation("switchyard-implementation-xml-1.0.xml");
    ...
    public void addXMLPath() throws Exception {
        V1CamelImplementationModel camelConfig = new V1CamelImplementationModel(Constants.COMPONENT_NAMESPACE_V1_0);
    ...
    public void writeConfig() throws Exception {
        final String control = getCamelImplementation("switchyard-implementation-java-1.0.xml").toString();
        final String test = createModel().toString();
        XMLAssert.assertXMLEqual(control, test);
    }

    private V1CamelImplementationModel createModel() {
        return new V1CamelImplementationModel(Constants.COMPONENT_NAMESPACE_V1_0).setJavaClass(SingleRouteService.class.getName());
    }
