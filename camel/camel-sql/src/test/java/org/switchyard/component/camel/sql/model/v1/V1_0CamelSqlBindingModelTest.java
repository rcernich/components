 ...
 */
public class V1_0CamelSqlBindingModelTest extends V1CamelSqlBindingModelTest {

    private static final String CAMEL_XML = "/v1/switchyard-sql-binding-beans-1.0.xml";
    private static final String CAMEL_URI = "sql://INSERT INTO events VALUES(?, ?, ?)?dataSourceRef=myDS&batch=false&placeholder=?";

    public V1_0CamelSqlBindingModelTest() {
        super(CAMEL_XML, Constants.SQL_NAMESPACE_V1_0);
    }
