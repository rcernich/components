 ...
 */
public class V1_0CamelNettyUdpBindingModelTest extends V1CamelNettyUdpBindingModelTest {

    private static final String CAMEL_XML = "/v1/switchyard-netty-udp-binding-beans-1.0.xml";

    private static final String CAMEL_URI = "netty:udp://google.com:10231?broadcast=true";

    public V1_0CamelNettyUdpBindingModelTest() {
