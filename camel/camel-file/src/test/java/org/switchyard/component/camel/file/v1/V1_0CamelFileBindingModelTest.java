 ...
 */
public class V1_0CamelFileBindingModelTest extends V1CamelFileBindingModelTest {

    private static final String CAMEL_XML = "/v1/switchyard-file-binding-beans-1.0.xml";
    ...
    public V1_0CamelFileBindingModelTest() {
