 ...
 */
public class V1_0CamelJpaProducerBindingModelTest extends V1CamelJpaProducerBindingModelTest {

    private static final String CAMEL_XML = "/v1/switchyard-jpa-binding-producer-beans-1.0.xml";

    private static final String CAMEL_URI = "jpa://some.clazz.Name?persistenceUnit=MyPU&flushOnSend=false&usePersist=false";

    public V1_0CamelJpaProducerBindingModelTest() {
